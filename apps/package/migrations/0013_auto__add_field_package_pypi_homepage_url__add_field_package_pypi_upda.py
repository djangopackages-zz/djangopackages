...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.pypi_homepage_url'
        db.add_column('package_package', 'pypi_homepage_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Package.pypi_updated_ts'
        db.add_column('package_package', 'pypi_updated_ts', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding unique constraint on 'Package', fields ['pypi_url']
        db.create_unique('package_package', ['pypi_url'])

        # Adding field 'Version.order'
        db.add_column('package_version', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'Package', fields ['pypi_url']
        db.delete_unique('package_package', ['pypi_url'])

        # Deleting field 'Package.pypi_homepage_url'
        db.delete_column('package_package', 'pypi_homepage_url')

        # Deleting field 'Package.pypi_updated_ts'
        db.delete_column('package_package', 'pypi_updated_ts')

        # Deleting field 'Version.order'
        db.delete_column('package_version', 'order')
    ...
    models = {
        ...
        'package.package': {
            ...
            'pypi_homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'pypi_updated_ts': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'pypi_url': ('django.db.models.fields.URLField', [], {'default': "''", 'unique': 'True', 'max_length': '200', 'blank': 'True'}),
